...
import com.yangfan.mvp.utils.ColorUtils;
import com.yangfan.mvp.utils.DisplayUtil;
...
public class OptionalLayout extends LinearLayout {
    ...
    public OptionalLayout(Context context, AttributeSet attrs) {
        ...
        tvStatus.setTextColor(ColorUtils.COLOR_999999);
        ...
        tvLogin.setTextColor(ColorUtils.COLOR_20212A);
...
//                break;
            case NO_DATA:
                ...
                setTextToTvStatus(R.string.no_login);
